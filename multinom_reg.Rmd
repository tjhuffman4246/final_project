...
write_rds(filter(pitches, game_year %in% c(2015, 2016, 2017)),
          "shiny_initial/pitches_early.rds")

write_rds(filter(pitches, game_year %in% c(2018, 2019)),
          "shiny_initial/pitches_late.rds")
