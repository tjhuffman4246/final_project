...
Below is code written to gather five years of Baseball Savant data. It takes a long time to run, but the data output is in the [GitHub repository](https://github.com/tjhuffman4246/finalproject_initial) created for this project.
